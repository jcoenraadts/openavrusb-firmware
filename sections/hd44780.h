...
#define HD44780_DDADDR(addr) \
	(0x80 | ((addr) & 0x7f))        //line 1
#define HD44780_DDADDR2(addr) \
        (0xC0 | ((addr) & 0x7f))        //line 2

/* HD44780 LCD port connections */
#define LCD_PORT D
#define HD44780_RS LCD_PORT, 0
#define HD44780_RW LCD_PORT, 1
#define HD44780_E  LCD_PORT, 2
/* The data bits have to be in ascending order. */
#define HD44780_D4 LCD_PORT, 4
